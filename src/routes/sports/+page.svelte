...
<footer>
    <p class="text" style="font-size: 20px, font-family: Droid Serif">
        NOSTRMINUSNOSTR presents INTERNATIONAL SPORTS UNCENSORED
    </p>
    <p class="date, font-family: Droid Serif">
        {formattedDate}
    </p>
    <p class="text, font-family: Droid Serif">
    ...
    <p class="date" style="margin-bottom: 10px, font-family: Droid Serif">
