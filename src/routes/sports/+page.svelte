<script>
    ...
    function fetchEventFromSub() {
        sub = ndk.subscribe({ kinds: [1], created_at: { $gte: lastWeek }, }, { closeOnEose: false });
        let matchedEvents = [];
        let combinedEvents = {};
