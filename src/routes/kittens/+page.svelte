<script>
    ...
    const ndk = new NDK({
        explicitRelayUrls: [ "wss://fiatjaf.com", "wss://relay.damus.io", "wss://relay.primal.net", "wss://relay.bitcoinpark.com", "wss://nos.lol", "wss://relay.snort.social", "wss://relay.nostr.band" ],
    });
